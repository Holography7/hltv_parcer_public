...
class Match(Program):
    ...
    def __init__(self, title, date_match, tournament, format, url):
        ...
        try:
            ...
            try:
                if soup.find('div', class_='countdown').text == 'Match deleted':
                    self.data.extend([title, None, None, None, None, date_match, tournament, format, None, 'Match deleted', None, url])
